...
public class ExperimentResource {
	...
	@POST
	@Path("/{id}")
	public Response addExperiment(@PathParam("id") String id, Experiment experiment) {
		return Response.ok().build();
	}

	@PUT
	@Path("/{id}")
	public Response updateExperiment(@PathParam("id") String id, Experiment experiment) {
		return Response.ok().build();
	}
